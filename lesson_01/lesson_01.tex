...
\begin{frame}{Memory}
  ...
  \item<5-> Cache\only<8->{\footnote{Based on Intel Skylake series processors, announced August 2015}} \only<6->{ - On the processor silicon directly}
    \begin{itemize}
...
\begin{frame}[fragile]{Assembly Language}
  ...
  More assembler instructions can be found on
      \href{https://en.wikipedia.org/wiki/X86_instruction_listings}{Wikipedia}\only<handout>{\footnote{\url{https://en.wikipedia.org/wiki/X86_instruction_listings}}}
      or on
      \href{http://www.intel.com/content/dam/www/public/us/en/documents/manuals/64-ia-32-architectures-software-developer-instruction-set-reference-manual-325383.pdf}{Intel's Website (pdf)}\only<handout>{\footnote{\url{http://www.intel.com/content/dam/www/public/us/en/documents/manuals/64-ia-32-architectures-software-developer-instruction-set-reference-manual-325383.pdf}}}
\end{frame}
